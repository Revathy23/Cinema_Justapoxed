...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <div class="container" style="margin-top: 100px;">
      ...
      <div class="row" >
        ...
        <?php
          $sql = "SELECT * FROM `tamil` ORDER BY RAND() LIMIT 1";
    ...
    <div class="container" style="margin-top: 100px;">
      <h2 align="center" style=" font-family: 'Abril Fatface', cursive;">RECENT HITS</h2>
      <br>
      <div class="row" >
...
<div class="container" style="margin-top: 100px;">
      <h2 align="center" style=" font-family: 'Abril Fatface', cursive;">2010s HITS</h2>
      <br>
      <div class="row" >
        ...
        <?php
          ...
          while($result=mysqli_fetch_array($sth))
          {
            if($result['year']>2009 && $result['year']<2020)
            {
            ?>
        <div class="col-sm-6">
         <div class="card flex-md-row mb-4 shadow-sm h-md-250">
...
<div class="container" style="margin-top: 100px;">
      <h2 align="center" style=" font-family: 'Abril Fatface', cursive;">2000s HITS</h2>
      <br>
      <div class="row" >
        ...
        <?php
          ...
          while($result=mysqli_fetch_array($sth))
          {
            if($result['year']>1999 && $result['year']<2010)
            {
            ?>
        <div class="col-sm-6">
         <div class="card flex-md-row mb-4 shadow-sm h-md-250">
...
<div class="container" style="margin-top: 100px;">
      <h2 align="center" style=" font-family: 'Abril Fatface', cursive;">1990s HITS</h2>
      <br>
      <div class="row" >
        ...
        <?php
          ...
          while($result=mysqli_fetch_array($sth))
          {
            if($result['year']>1989 && $result['year']<2000)
            {
            ?>
        <div class="col-sm-6">
         <div class="card flex-md-row mb-4 shadow-sm h-md-250">
...
<div class="container" style="margin-top: 100px;">
      <h2 align="center" style=" font-family: 'Abril Fatface', cursive;">1980s HITS</h2>
      <br>
      <div class="row" >
        ...
        <?php
          ...
          while($result=mysqli_fetch_array($sth))
          {
            if($result['year']>1979 && $result['year']<1990)
            {
            ?>
        <div class="col-sm-6">
         <div class="card flex-md-row mb-4 shadow-sm h-md-250">
